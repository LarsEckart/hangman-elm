...
var $author$project$GameLogic$isLetterInWord = F2(
...
var $author$project$GameLogicTest$suite = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					'returns True when letter is in word',
					function (_v0) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2(
								$author$project$GameLogic$isLetterInWord,
								_Utils_chr('a'),
								'cat'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'returns False when letter is not in word',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
				...
				[
					...
					function (_v4) {
						return A2(
							...
							A2(
								$author$project$GameLogic$updateGuessedLetters,
								_Utils_chr('a'),
								_List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'adds new letter to existing list',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'shows all underscores when no letters guessed',
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'___',
							A2($author$project$GameLogic$getMaskedWord, 'cat', _List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'shows guessed letters in correct positions',
					function (_v9) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'_a_',
							A2(
								$author$project$GameLogic$getMaskedWord,
								'cat',
								_List_fromArray(
									[
										_Utils_chr('a')
					...
					A2(
					$elm_explorations$test$Test$test,
					'shows all letters when all are guessed',
					function (_v10) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'cat',
					...
					function (_v11) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'',
							A2($author$project$GameLogic$getMaskedWord, '', _List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'is case insensitive',
				...
				[
					...
					function (_v13) {
						return A2(
							...
							true,
							A2(
								$author$project$GameLogic$isGameWon,
								'cat',
								_List_fromArray(
									[
										_Utils_chr('c'),
					...
					A2(
					$elm_explorations$test$Test$test,
					'returns False when some letters are missing',
					function (_v14) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
					...
					A2(
					$elm_explorations$test$Test$test,
					'returns False when no letters are guessed',
					function (_v15) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$GameLogic$isGameWon, 'cat', _List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'returns True for empty word',
					function (_v16) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$GameLogic$isGameWon, '', _List_Nil));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'handles duplicate letters in word',
					function (_v17) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'returns True when no guesses remaining',
					function (_v18) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							$author$project$GameLogic$isGameLost(0));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'returns False when guesses remaining',
					function (_v19) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							$author$project$GameLogic$isGameLost(1));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'returns False when many guesses remaining',
					function (_v20) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							$author$project$GameLogic$isGameLost(6));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'returns True for single letter',
					function (_v21) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
...
var pipeFilename = "/tmp/elm_test-123110.sock";
var net = require('net'),
