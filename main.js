...
var $author$project$GameLogic$isGameLost = function (remainingGuesses) {
...
var $author$project$GameLogic$isGameWon = F2(
	function (word, guessedLetters) {
		var lowerWord = $elm$core$String$toLower(word);
		var uniqueLetters = A3(
			$elm$core$List$foldr,
			F2(
				function (_char, acc) {
					return A2($elm$core$List$member, _char, acc) ? acc : A2($elm$core$List$cons, _char, acc);
				}),
			_List_Nil,
			$elm$core$String$toList(lowerWord));
		var lowerGuessed = A2($elm$core$List$map, $elm$core$Char$toLower, guessedLetters);
		return A2(
			$elm$core$List$all,
			function (_char) {
				return A2($elm$core$List$member, _char, lowerGuessed);
			},
			uniqueLetters);
	});
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$GameLogic$updateGuessedLetters = F2(
	function (letter, guessedLetters) {
		var lowerLetter = $elm$core$Char$toLower(letter);
		return A2($elm$core$List$member, lowerLetter, guessedLetters) ? guessedLetters : _Utils_ap(
			guessedLetters,
			_List_fromArray(
				[lowerLetter]));
	});
...
var $author$project$Main$viewDifficultySelection = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('screen difficulty-screen')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('screen-title')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Choose Difficulty')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('difficulty-buttons')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('difficulty-button easy'),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('difficulty-description')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('3-5 letter words')
								]))
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('difficulty-button medium'),
							$elm$html$Html$Events$onClick(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('6-8 letter words')
								]))
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('difficulty-button hard'),
							$elm$html$Html$Events$onClick(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('9+ letter words')
								]))
						]))
				]))
		]));
...
var $author$project$Main$formatGuessedLetters = function (letters) {
	return $elm$core$List$isEmpty(letters) ? 'None' : A2(
		$elm$core$String$join,
		', ',
		A2(
			$elm$core$List$map,
			A2($elm$core$Basics$composeR, $elm$core$String$fromChar, $elm$core$String$toUpper),
			letters));
};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$Main$viewGameOver = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('screen game-over-screen')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('game-result')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								'result-message ' + (_Utils_eq(model.gameState, $author$project$Types$Won) ? 'won' : 'lost'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								_Utils_eq(model.gameState, $author$project$Types$Won) ? '🎉 You Won!' : '💀 You Lost!')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('word-reveal')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('word-label')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('The word was:')
									])),
								A2(
								$elm$html$Html$h2,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('revealed-word')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$toUpper(model.currentWord))
									]))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('game-stats')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Guessed letters: ' + $author$project$Main$formatGuessedLetters(model.guessedLetters))
									])),
								A2(
								$elm$html$Html$p,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Remaining guesses: ' + $elm$core$String$fromInt(model.remainingGuesses))
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('game-over-buttons')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick($author$project$Types$PlayAgain)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('back-to-start-button'),
								$elm$html$Html$Events$onClick($author$project$Types$BackToStart)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Back to Start')
							]))
					]))
			]));
};
...
var $author$project$Main$formatMaskedWord = function (word) {
	return A2(
		$elm$core$String$join,
		' ',
		A2(
...
var $author$project$Main$getDifficultyName = function (maybeDifficulty) {
	if (maybeDifficulty.$ === 'Just') {
		switch (maybeDifficulty.a.$) {
			case 'Easy':
				var _v1 = maybeDifficulty.a;
				return 'Easy';
			case 'Medium':
				var _v2 = maybeDifficulty.a;
				return 'Medium';
			default:
				var _v3 = maybeDifficulty.a;
				return 'Hard';
		}
	} else {
		return 'Unknown';
		...
		return A2(
			...
			function (_char) {
				return A2(
					$elm$core$List$member,
					$elm$core$Char$toLower(_char),
					lowerGuessed) ? $elm$core$Char$toLower(_char) : _Utils_chr('_');
			},
			lowerWord);
	});
...
var $author$project$Main$viewErrorMessage = function (maybeError) {
	if (maybeError.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('clear-error-button'),
							$elm$html$Html$Events$onClick($author$project$Types$ClearError)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('×')
...
var $author$project$Main$viewGameScreen = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('screen game-screen')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('game-info')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('difficulty-display')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Difficulty: ' + $author$project$Main$getDifficultyName(model.selectedDifficulty))
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('remaining-guesses')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('word-display')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('masked-word')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Main$formatMaskedWord(
									A2($author$project$GameLogic$getMaskedWord, model.currentWord, model.guessedLetters)))
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('guessed-letters')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('guessed-title')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Guessed letters:')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('guessed-list')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Main$formatGuessedLetters(model.guessedLetters))
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('guess-input')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Types$UpdateInput),
								$elm$html$Html$Attributes$placeholder('Enter a letter...'),
								$elm$html$Html$Attributes$class('letter-input'),
								$elm$html$Html$Attributes$disabled(
								!_Utils_eq(model.gameState, $author$project$Types$Playing))
							]),
						_List_Nil),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Types$MakeGuess),
								$elm$html$Html$Attributes$class('guess-button'),
								$elm$html$Html$Attributes$disabled(
								(!_Utils_eq(model.gameState, $author$project$Types$Playing)) || $elm$core$String$isEmpty(model.userInput))
							]),
						_List_fromArray(
							[
...
var $author$project$Main$viewStartScreen = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('screen start-screen')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('game-title')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('🎯 HANGMAN GAME')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('game-description')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Guess the word letter by letter!')
				])),
			A2(
			$elm$html$Html$button,
			_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				function () {
				var _v0 = model.currentScreen;
				switch (_v0.$) {
					case 'Start':
						return $author$project$Main$viewStartScreen;
					case 'DifficultySelection':
						return $author$project$Main$viewDifficultySelection;
					case 'Game':
