...
errorToString uiLanguage error =
    case error of
        NoWordsAvailable language category ->
            ...
            case uiLanguage of
                English ->
                    "No words available for " ++ languageToString language ++ " " ++ categoryToString category

                German ->
                    "Keine Wörter verfügbar für " ++ languageToString language ++ " " ++ categoryToString category

                Estonian ->
                    "Selle kombinatsiooni jaoks pole sõnu saadaval: " ++ languageToString language ++ " " ++ categoryToString category
