            ...
            [ test "falls back to BackToStart when selections are missing" <|
                \_ ->
                    let
                        ...
                        updatedModel =
                            updateModel PlayAgain gameOverModel
                    in
                    Expect.all
            ...
            [ test "SelectCategory handles no words available scenario" <|
                \_ ->
                    let
                        ...
                        updatedModel =
                            updateModel (SelectCategory Sport) modelWithSelections
                    in
                    -- Should either generate a random word or show error - depends on word availability
                    Expect.notEqual updatedModel.currentScreen Start
            ...
            , test "SelectCategory with language missing" <|
                \_ ->
                    let
                        ...
                        updatedModel =
                            updateModel (SelectCategory Animals) modelWithoutSelections
                    in
            ...
            , test "MakeGuess with winning guess on single letter word" <|
                \_ ->
                    let
                        ...
                        updatedModel =
                            updateModel MakeGuess gameModel
                    in
                    Expect.all
            ...
            , test "handles consecutive wins and losses" <|
                \_ ->
                    let
                        ...
                        secondUpdate =
                            updateModel PlayAgain firstUpdate

                        thirdUpdate =
                            updateModel (SelectLanguage English) secondUpdate
                    in
                    Expect.all
